          ...
          <div className="bg-white rounded-lg border border-gray-200 p-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                ...
                className="flex items-center gap-1.5 bg-[#0f6f6b] text-white text-sm font-medium px-4 py-1.5 rounded-full hover:bg-[#0c5d5a] transition"
              >
                <Plus size={15} />
                Ask a question
              </Link>
                  ...
                  <div className={viewMode === 'card' ? 'p-4' : 'px-3 py-2'}>
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        >
                          <h3
                            className={`font-semibold text-black group-hover:text-[#0f6f6b] transition-colors ${
                              viewMode === 'card'
                                ? 'text-base mb-1'
                                : 'text-sm mb-0'
                            }`}
