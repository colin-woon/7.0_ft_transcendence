                ...
                >
                  <div className={viewMode === "card" ? "p-4" : "px-3 py-2"}>
                    <div className="flex gap-3">
                      ...
                      {/* Vote */}
                      <div className="flex flex-col items-center gap-1 text-xs text-slate-500 shrink-0">
                        <button className="hover:bg-gray-100 rounded p-1 hover:text-[#0f6f6b] transition">▲</button>
                        <span className="font-medium text-slate-700">{post.upvotes}</span>
                        <button className="hover:bg-gray-100 rounded p-1 hover:text-red-400 transition">▼</button>
                      </div>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <h3 className={`font-semibold hover:text-[#0f6f6b] transition-colors ${
