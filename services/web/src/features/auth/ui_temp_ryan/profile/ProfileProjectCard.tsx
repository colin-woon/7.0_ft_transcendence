        ...
        <div className="space-y-2">
          {projects.map((project) => {
            ...
            if (project.score !== null) {
              // Clamp score between 0 and 125, then map to 10–40
              // const clamped = Math.max(0, Math.min(project.score, 125));
              opacity = Math.round(((project.score / 125) * 30) / 10) * 10; // 0 → 10, 125 → 30
            }
