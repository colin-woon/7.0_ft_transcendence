...
export default function ChatSidebar() {
  ...
  return (
    <div className="flex flex-col h-full bg-base-200 text-base-content w-full">
      {/* Search Header */}
      <div className="p-4 shadow-sm z-10 sticky top-0 bg-base-200">
        <label className="input input-sm input-bordered flex items-center gap-2 bg-base-300 w-full focus-within:outline-none focus-within:border-primary">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70">
            <path fillRule="evenodd" d="M9.965 11.026a5 5 0 1 1 1.06-1.06l2.755 2.754a.75.75 0 1 1-1.06 1.06l-2.755-2.754ZM10.5 7a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Z" clipRule="evenodd" />
          </svg>
          <input type="text" className="grow text-sm" placeholder="Find or start a conversation" />
        </label>
      </div>
