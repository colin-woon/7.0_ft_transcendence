        ...
        <div className="max-w-7xl mx-auto px-4 py-1.5">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <Link href="/home" className="text-slate-900 text-xl font-bold hidden sm:inline hover:text-[#0f6f6b] transition-colors">
                42 overflow
              </Link>
            </div>
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              ...
              <button
                ...
                className={`p-2 rounded-full text-slate-700 transition relative ${isChatOpen ? 'bg-[#8EE7E3]/20 text-[#0f6f6b]' : 'hover:bg-[#8EE7E3]/15'}`}
              >
