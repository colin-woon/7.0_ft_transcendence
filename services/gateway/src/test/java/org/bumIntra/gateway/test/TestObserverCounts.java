...
//
// private final ConcurrentHashMap<String, AtomicInteger> starts = new
// ConcurrentHashMap<>();
// private final ConcurrentHashMap<String, AtomicInteger> ends = new
// ConcurrentHashMap<>();
//
// @Override
// public void onRequestStart(GatewayRequestStart e) {
// starts.computeIfAbsent(e.requestId(), k -> new
// AtomicInteger()).incrementAndGet();
// }
//
// @Override
// public void onRequestEnd(GatewayRequestEnd e) {
// ends.computeIfAbsent(e.requestId(), k -> new
// AtomicInteger()).incrementAndGet();
// }
//
