package org.bumIntra.gateway.stream;
...
public class SseProxyService {
    ...
    private static final Logger LOG = Logger.getLogger(SseProxyService.class);
    ...
    public Response buildStream(Response upstream) {
